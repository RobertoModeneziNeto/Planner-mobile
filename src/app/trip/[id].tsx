  ...
  return (
    <View className="flex-1 px-5 pt-16">
      ...
      <View className="w-full absolute -bottom-1 self-center justify-end pb-5 z-10 bg-zinc-950">
        <View className="w-full flex-row bg-zinc-900 p-4 rounded-lg border border-zinc-800 gap-2 flex justify-around">
          ...
          >
            <View className="flex items-center">
              <CalendarRange
                color={
                  option === "activity" ? colors.lime[300] : colors.zinc[200]
                }
                size={20}
              />
            </View>
          ...
          >
            <View className="flex items-center">
              <Info
                color={option === "details" ? colors.lime[300] : colors.zinc[200]}
                size={20}
              />
            </View>
